...
INVITE_CODE="$4" # Obtained from Settings > App Deployment > Invite Code
DEPLOYMENT_KEY="$5" # Obtained from Settings > App Deployment > Zero-Touch Deployment Using a Device Manager
APP_VERSION="$6"
